...
import AppleWallpaper from '../Apple Wallpaper.jpeg'
import image1 from '../images.1png.png';
import image2 from '../images.3png.png';
import image3 from '../image4.jpeg';
import image4 from '../imag4.png';
    ...
    <>
      ...
      <div className="display-name container" style={myStyle} >
        <div className="card margin-unit" style={{ width: '18rem', myStyle }}>
          <img src={image4} className="card-img-top" style={myStyle} alt="no internet" />
        ...
        <div className="card margin-unit" style={{ width: '18rem', myStyle }}>
          <img src={image2} className="card-img-top" style={myStyle} alt="no internet" />
          <div className="card-body" style={myStyle}>
        ...
        <div className="card margin-unit" style={{ width: '18rem', myStyle }}>
          <img src={image1}className="card-img-top" style={myStyle} alt="no internet" />
          <div className="card-body" style={myStyle}>
        ...
        <div className="card margin-unit" style={{ width: '18rem', myStyle }}>
          <img src={image3} className="card-img-top" style={myStyle} alt="no internet" />
          <div className="card-body" style={myStyle}>
